...
if flag_defaultsInitialized == True:
    ...
    if args.listdev == True:
        ...
        print("Saved defaults to _data/defaults.npy with inputdevice =", args.inputdevice, "and outputdevice =", args.outputdevice)
        ...
        # Truncate
        lenRIR = 1.2;
        startId = testStimulus.Lp - args.endsilence*args.fs -1
